...
移动端优先的 Pokémon Champions Regulation Set M-A 对战助手 PWA。当前分支正在推进“环境优先”重构：默认入口提供环境榜单与高分队伍样本，队伍、伤害计算、速度线、规则图鉴和本地数据管理继续保留为完整工具闭环。
...
- 环境：单打 / 双打切换、宝可梦榜、完整榜单、宝可梦环境详情、常用招式、携带道具、常见队友、相关高分队伍
- 高分队伍样本：展示作者 / 分数 / 核心描述 / 6 只 Pokémon，支持导入配置和队报链接
