...
//
// Scope: the 6 new Mega form thumbs/artwork and the 18 new item icons — the assets keyed by a
// Champions-only form id or item id, which no generator can discover on its own.
//
// New *base* Pokémon are NOT this script's concern: their thumbs/artwork are keyed by national dex
// number and `scripts/generate-pokemon-icons.mjs` auto-discovers them from the catalog, so the M-C
// base species (catalog-batch-007) were fetched by that script instead.
//
