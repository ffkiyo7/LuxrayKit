/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/environment-worker/wrangler.jsonc cloudflare/environment-worker/src/worker-configuration.d.ts` (hash: 21e31eb92e760b4144c1e3834dd0ba8f)
// Runtime types generated with workerd@1.20260811.1 2026-06-06 
interface __BaseEnv_Env {
	ENVIRONMENT_CACHE: KVNamespace;
	LUXRAY_ANALYTICS: AnalyticsEngineDataset;
	ASSETS: Fetcher;
	POKEDB_BASE_URL: "https://champs.pokedb.tokyo";
	POKEDB_DETAIL_LIMIT: "60";
	POKEDB_DETAIL_CHUNK_SIZE: "20";
	ENVIRONMENT_AUDIT_UNKNOWN_THRESHOLD: "0";
	MAX_CACHE_AGE_SECONDS: "108000";
	ALLOWED_ORIGINS: "*";
	SCHEDULED_MAX_JITTER_MS: "90000";
	ENVIRONMENT_REFRESHER: DurableObjectNamespace<import("./index").EnvironmentRefreshDurableObject>;
	FEEDBACK_INBOX: DurableObjectNamespace<import("./index").FeedbackInboxDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "EnvironmentRefreshDurableObject" | "FeedbackInboxDurableObject";
	}
