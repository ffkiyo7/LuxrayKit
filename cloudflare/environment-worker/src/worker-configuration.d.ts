/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/environment-worker/wrangler.jsonc cloudflare/environment-worker/src/worker-configuration.d.ts` (hash: 12644fd8c141ea606a40d0ef061156f7)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "EnvironmentRefreshDurableObject";
	}
