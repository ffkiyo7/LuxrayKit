/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config cloudflare/environment-worker/wrangler.jsonc cloudflare/environment-worker/src/worker-configuration.d.ts` (hash: e7fae5894003aecae4e845f4095923ba)
