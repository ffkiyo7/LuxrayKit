...
const SPECIES_ID_MAP: Record<string, string> = {
  'raichu-alola': 'raichualola', 'ninetales-alola': 'ninetalesalola',
  ...
  'meowstic-female': 'meowsticf', 'goodra-hisui': 'goodrahisui',
  'gourgeist-average': 'gourgeist', 'gourgeist-small': 'gourgeistsmall',
  'gourgeist-large': 'gourgeistlarge', 'gourgeist-super': 'gourgeistsuper',
  'avalugg-hisui': 'avalugghisui', 'decidueye-hisui': 'decidueyehisui',
  'lycanroc-midday': 'lycanroc', 'lycanroc-midnight': 'lycanrocmidnight',
