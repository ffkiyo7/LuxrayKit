const CACHE_NAME = 'champions-tool-v5';
const APP_SHELL = ['/', '/index.html', '/manifest.webmanifest', '/icon.svg', '/data/pokedb/reg-ma-environment.json', '/data/vgcpastes/reg-ma-champions-ma-team-samples.json'];
