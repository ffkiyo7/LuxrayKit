...
| 外部环境统计、队伍样本与抓取事实 | `src/data/external/**`、`public/data/pokedb/**` | 来源包括 PokeDB、VGCPastes 及原队伍作者，以及 PokeAPI（`src/data/external/pokeapi/`）。仓库保留来源标记；再使用时还需遵守对应来源的条款。 |
...
详细来源与风险分级记录在 [`src/data/seed/regMA/metadata.ts`](./src/data/seed/regMA/metadata.ts) 的 `dataSourceManifest`；2026-06 的一次性资产来源审计快照见 [`docs/archive/ASSET_SOURCE_AUDIT.md`](./docs/archive/ASSET_SOURCE_AUDIT.md)。
